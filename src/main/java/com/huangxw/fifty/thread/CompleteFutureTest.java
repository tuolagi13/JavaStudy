...
public class CompleteFutureTest {
    ...
    public void testCallBack() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<String> completeFuture = CompletableFuture.supplyAsync(new Supplier<String>() {
            @Override
            public String get() {
        ...
        completeFuture.whenComplete(new BiConsumer<String, Throwable>() {
            @Override
    ...
    @Test
    public void testCallBack2() throws ExecutionException, InterruptedException {
        //任务1：把第一个任务推进去，顺便开启异步线程
